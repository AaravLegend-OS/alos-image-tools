...
"@
            ...
            try {
                ...
                if ($Missing) {
                    ...
                    if ($Hash -cne "D8611EB2354EFFB4E66574F6085A6EF0B3BE12FF6D3115F4E61167CF010AEB4A") { Warn "SHA256 hash does not match. ($Hash)"; Clear-Host; return $false } # If the hash does not match, throw an error. An empty hash target always throws an error.
